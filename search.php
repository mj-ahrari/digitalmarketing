...
$func = new functions();
$product = new product();
$res = $product->search($_GET['txt-search']);
?>
...
<body>
	...
	<div id="fullpage">
        ...
        <div id="otherproducts">
        	<div class="op-title" style="padding-top:3px; margin-top:5px; border-radius:0px;margin-right:15px;">نتایج جستجو</div>
